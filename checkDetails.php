...
function search_result($des, $timeA, $timeB){
    ...
    if($des=="YSSY"){
        ...
        $sql_time = "SELECT * FROM TimeTable WHERE dest='YSSY' and detDay ='Fri'";
    }
    if($des=="NZRO"){
        ...
        $sql_time = "SELECT * FROM TimeTable WHERE dest='NZRO' and (detDay ='Fri' or detDay ='Thu' or detDay ='Wed' or detDay ='Tue' or detDay ='Mon')";
    }
    if($des=="NZCI"){
        ...
        $sql_time = "SELECT * FROM TimeTable WHERE dest='NZCI' and (detDay ='Fri' or detDay ='Tue')";
    }
    if($des=="NZGB"){
        ...
        $sql_time = "SELECT * FROM TimeTable WHERE dest='NZGB' and (detDay ='Fri' or detDay ='Wed' or detDay ='Mon')";
    }
    if($des=="NZTL"){
        ...
        $sql_time = "SELECT * FROM TimeTable WHERE dest='NZTL' and detDay ='Mon'";
    }
...
<div class="maintable" method="post">
    <table class="table1" >
        ...
        <tr>
            ...
            <td  class = "td1" >From:  NZNE </td>
            <td  class = "td1" >To:  <?php   echo $_POST['fly_to'] ;      ?></td>
        </tr>
